...
public class CommonUtil {
    ...
    public static Date getMinuteDate() {
        return org.apache.commons.lang3.time.DateUtils.addMinutes(org.apache.commons.lang3.time.DateUtils.setSeconds(DateUtils.setMilliseconds(getDate(), 0), 0), 1);
    }
    ...
    public static boolean notEmpty(String var) {
        return org.apache.commons.lang3.StringUtils.isNotBlank(var);
    }
    ...
    public static boolean empty(String var) {
        return org.apache.commons.lang3.StringUtils.isBlank(var);
    }
    ...
    public static String join(Object[] var, String separator) {
        if (empty(var)) {
            ...
            return org.apache.commons.lang3.StringUtils.join(var, ",");
        }
    }
    ...
    public static List<Ztree> getTree(List<Ztree> nodes, Object id) {
        List<Ztree> nNodes = new ArrayList<>();
        Iterator<Ztree> it = nodes.iterator();
        while (it.hasNext()) {
            Ztree _Node = it.next();
